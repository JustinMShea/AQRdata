#' Responsible Investing: The ESG-Efficient Frontier – Original Paper Data (VW.S)
#'
#' This file contains the Non-Sin Stocks (S) value-weighted portfolios. 
#'
