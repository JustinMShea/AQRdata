#' AQR Momentum Indices, Yearly
#'
#' Momentum is an investment style that has been studied extensively by academics 
#' for many years. The evidence for momentum is pervasive and supported by almost
#' two decades of academic and practitioner research. Studies have documented 
#' momentum in the U.S. as far back as the Victorian age. The evidence also shows 
#' that momentum works broadly across asset classes, including foreign stocks, 
#' bonds, commodities, currencies, index futures, and global country selection. 
#' AQR has developed methodologies for U.S. and international markets that 
#' capture momentum in an intuitive and transparent way. The methodology can be 
#' applied to any universe of stocks. At present, AQR has created momentum indices 
#' for three distinct markets:
#' 
...
#' 
#' Each of the indices is constructed using a simple and transparent methodology 
#' that captures the essence of the momentum effect:
#' 
#' The investment universe is screened based on market capitalization, liquidity 
#' and other considerations.
#' 
#' The stocks in the investment universe are ranked by their total return over 
#' the prior twelve months, excluding the last month.
#' The top 33% of stocks with the highest rank are included, and weighted based 
#' on their market capitalization.
#' The index is reconstituted quarterly.
#'
#' Data loads lazily.
#'
#' @section Notes: This file contains monthly returns of the test assets.
#'
#' @docType data
#'
#' @usage data('AQR.MOM.Yearly')
#'
#' @format An xts object on Jan 1972 / Jul 2011 containing: Data: 475 entries, 22 total columns
#' \itemize{
#'  \item \strong{Date:} Date, monthly periodicity. Formatted in as a Date object in %Y-%m format.
#'  \item \strong{US.LC:} Excess returns of Momentum on Large-Cap and Mid-Cap U.S. Equities
#'  \item \strong{Us.SC:} Excess returns of Momentum on US Small-Cap U.S. Equities. 
#'  \item \strong{Int:} Excess returns of Momentum on International (Non-U.S.) Equities. 
#' }
#' @source
#'
