#' Quality Minus Junk: Up Minus Down (UMD) factors, Daily
#'
...
#' @docType data
#'
#' @usage data('QMJ.Factors.UMD.Daily')
#'
...
#'  monthly self-financing returns of equity Up Minus Down (UMD) factors. 
...
#'  that is monthly self-financing returns of equity Up Minus Down (UMD) factors. 
...
#'  except USA that is monthly self-financing returns of equity Up Minus Down (UMD) factors. 
...
#' @examples  str(QMJ.Factors.UMD.Daily)
"QMJ.Factors.UMD.Daily"
