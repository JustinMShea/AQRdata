#' Betting Against Beta: High Minus Low (HML.FF) factors, Monthly
#' 
...
#' @docType data
#'
#' @usage data('BAB.Factors.HML.FF.Monthly')
#'
...
#'  self-financing returns of equity High Minus Low (HML) factors using the Book to Market definition of Fama and French (1992). 
...
#' @examples  str(BAB.Factors.HML.FF.Monthly)
"BAB.Factors.HML.FF.Monthly"
