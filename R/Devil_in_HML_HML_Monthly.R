#' The Devil in HML's Details: High Minus Low (HML) factors, Monthly
#' 
...
#' 2013). This paper challenges the standard method for measuring “value” used 
#' in academic work on factor pricing and behavioral finance. The standard method 
...
#' alternatives that use more timely price data while retaining the necessary lag 
#' for measuring book. We construct portfolios based on the different measures for 
#' U.S. and International samples. We show that B/P ratios based on more timely 
#' prices better forecast true (unobservable) B/P ratios at fiscal year-end. 
#' Value portfolios based on the most timely measures (HML Devil) earn 
#' statistically significant alphas ranging between 305 and 378 basis point per 
#' year against a 5-factor model itself containing the standard measure of value, 
#' as well as market, size, momentum and a short term reversal factor.
#' 
#' This data set is an updated and extended version of the paper data, with 
#' long/short HML Devil returns for the U.S. and 23 international equity markets 
#' updated monthly. We also provide the returns for several additional global 
...
#'  that is self-financing returns of equity High Minus Low (HML) factors using the Book to Market definition of Fama and French (1992). 
...
#'  except USA that is self-financing returns of equity High Minus Low (HML) factors using the Book to Market definition of Fama and French (1992). 
