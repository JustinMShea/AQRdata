#' Betting Against Beta: High Minus Low (HML.FF) factors, Daily
#' 
...
#' @docType data
#'
#' @usage data('BAB.Factors.HML.FF.Daily')
#'
...
#' @examples  str(BAB.Factors.HML.FF.Daily) 
"BAB.Factors.HML.FF.Daily"
