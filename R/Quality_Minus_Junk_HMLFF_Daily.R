#' Quality Minus Junk: High Minus Low (HML.FF) factors, Daily
#' 
...
#' @docType data
#'
#' @usage data('QMJ.Factors.HML.FF.Daily')
#'
...
#'  self-financing returns of equity High Minus Low (HML) factors using the Book 
#'  to Market definition of Fama and French (1992). 
...
#'  that is self-financing returns of equity High Minus Low (HML) factors using 
#'  the Book to Market definition of Fama and French (1992). 
...
#'  except USA that is self-financing returns of equity High Minus Low (HML) 
...
#' @examples  str(QMJ.Factors.HML.FF.Daily)
"QMJ.Factors.HML.FF.Daily"
