...
#'
#' This file contains the Low accuruals (G) equal-weighted portfolios. 
#'
...
#'  Abbreviated from original name of "High accruals 1/5 (G) ~ equal-weighted ~ G1" 
#'  \item \strong{G2:} Returns, Total returns of portfolios sorted by G
#'  Abbreviated from original name of "High accruals 2/5 (G) ~ equal-weighted ~ G2"
#'  \item \strong{G3:} Returns, Total returns of portfolios sorted by G
#'  Abbreviated from original name of "Medium accruals 3/5 (G) ~ equal-weighted ~ G3" 
#'  \item \strong{G4:} Returns, Total returns of portfolios sorted by G
#'  Abbreviated from original name of "Low accruals 4/5 (G) ~ equal-weighted ~ G4"
#'  \item \strong{G5:} Returns, Total returns of portfolios sorted by G
#'  Abbreviated from original name of "Low accruals 5/5 (G) ~ equal-weighted ~ G5"
#'  \item \strong{G5.1:} Returns, Total returns of portfolios sorted by G
#'  Abbreviated from original name of "Low (5/5) - High (1/5) accruals (G) ~ equal-weighted ~ G5 - G1"
#' }
#' @source
#'
#' Disclosures
