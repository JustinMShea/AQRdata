#' Quality Minus Junk: High Minus Low (HML.Devil) factors, Monthly
#' 
...
#' @docType data
#'
#' @usage data('QMJ.Factors.HML.Devil.Monthly')
#'
...
#'  that is self-financing returns of equity High Minus Low Devil (HML Devil) 
#'  actors using the Book to Market definition of Asness and Frazzini (2013). 
...
#' 
#' The size, value, and momentum factors are constructed using six value-weighted 
#' portfolios formed on size and book-to-market and 1-year return.
#' 
...
#' 
#' For International securities, the size breakpoint is the 80th percentile by country.
#' 
...
#' average return on the 3 big portfolios:
#' 
...
#' @examples  str(QMJ.Factors.HML.Devil.Monthly)
"QMJ.Factors.HML.Devil.Monthly"
