#' Betting Against Beta: High Minus Low (HML.Devil) factors, Monthly
#' 
...
#' @docType data
#'
#' @usage data('BAB.Factors.HML.Devil.Monthly')
#'
...
#' @examples  str(BAB.Factors.HML.Devil.Monthly)
"BAB.Factors.HML.Devil.Monthly"
