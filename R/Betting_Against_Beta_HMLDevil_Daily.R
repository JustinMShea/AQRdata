#' Betting Against Beta: High Minus Low (HML.Devil) factors, Daily
#' 
...
#' @docType data
#'
#' @usage data('BAB.Factors.HML.Devil.Daily')
#'
...
#' @examples  str(BAB.Factors.HML.Devil.Daily) 
"BAB.Factors.HML.Devil.Daily"
