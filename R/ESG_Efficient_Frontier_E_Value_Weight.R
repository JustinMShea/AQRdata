#' Responsible Investing: The ESG-Efficient Frontier – Original Paper Data (VW.E)
#'
#' This file contains the Low CO2 emissions (E) value-weighted portfolios. 
#'
