#' Quality Minus Junk: Small Minus Big (SMB) factors, Daily
#' 
#' This file contains monthly self-financing returns of equity Small Minus Big (SMB) factors.
#'
...
#' @docType data
#'
#' @usage data('QMJ.Factors.SMB.Daily')
#'
...
#'  self-financing returns of equity Small Minus Big (SMB) factors. 
...
#'  that is self-financing returns of equity Small Minus Big (SMB) factors. 
...
#'  except USA that is self-financing returns of equity Small Minus Big (SMB) factors. 
...
#' @examples  str(QMJ.Factors.SMB.Daily)
"QMJ.Factors.SMB.Daily"
