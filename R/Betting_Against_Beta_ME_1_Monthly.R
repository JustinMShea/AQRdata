#' Betting Against Beta: Factors ~ Total Market Value of Equity (ME) factors, 
#' lagged 1 month (Billion USD) (ME_1), Monthly
#' 
#' This file contains Total Market Value of Equity (ME) as of the prior month, 
#' in Billion US
#'
...
#' @docType data
#'
#' @usage data('BAB.Factors.ME_1.Monthly')
#'
...
#'  total Market Value of Equity (ME) as of the prior month, in Billion US. 
...
#'  that is total Market Value of Equity (ME) as of the prior month, in Billion US. 
...
#'  except USA that is total Market Value of Equity (ME) as of the prior month, in Billion US. 
...
#' @examples  str(BAB.Factors.ME_1.Monthly)
"BAB.Factors.ME_1.Monthly"
