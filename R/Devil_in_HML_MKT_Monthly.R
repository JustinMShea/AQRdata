#' The Devil in HML's Details: Excess of t-bill (MKT) Factors, Monthly
#'
...
#'  usign the current total market value of equity in excess of t-bills. 
...
#'  market values, usign the current total market value of equity in excess of t-bills. 
...
#'  book to market values, usign the current total market value of equity in excess of t-bills. 
