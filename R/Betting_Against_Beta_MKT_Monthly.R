#' Betting Against Beta: Excess of t-bill (MKT) Factors, Monthly
#'
...
#' @docType data
#'
#' @usage data('BAB.Factors.MKT.Monthly')
#'
...
#' @examples  str(BAB.Factors.MKT.Monthly)
"BAB.Factors.MKT.Monthly"
