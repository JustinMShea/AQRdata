#' Quality Minus Junk: Factors ~ Total Market Value of Equity (ME) factors, 
...
#' @docType data
#'
#' @usage data('QMJ.Factors.ME_1.Monthly')
#'
...
#' @examples  str(QMJ.Factors.ME_1.Monthly)
"QMJ.Factors.ME_1.Monthly"
